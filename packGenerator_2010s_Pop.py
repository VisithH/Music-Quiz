...
packId = gen.CreatePack("2010's Pop", "JWitham")

gen.InsertSong("The Nights", ["Avicii"], "Stories", """(Hey) Once upon a younger year
...
(Hey, hey)
Oh-oh (hey)
My father told me""", [packId, 12, 7]) # remember


gen.InsertSong("There's Nothing Holdin' Me Back", ["Shawn Mendes"], "Illuminate", """I wanna follow where she goes
...
Baby, there's nothing holdin' me back""", [packId, 24, 2]) # nothing



gen.InsertSong("Somebody That I Used To Know", ["Gotye", "Kimbra"], "Making Mirrors", """Now and then I think of when we were together
...
Somebody (I used to know)
(Somebody) now you're just somebody that I used to know
I used to know, that I used to know, I used to know somebody""", [packId, 5, 9]) # sadness


gen.InsertSong("It's Time", ["Imagine Dragons"], "Night Visions", """So this is what you meant
...
I'm just the same as I was
Now don't you understand
That I'm never changing who I am""", [packId, 10, 5]) # bigger


gen.InsertSong("Best Thing I Never Had", ["Beyoncé"], "4", """What goes around, comes back around, hey (my baby)
...
(What goes around, comes back around)
I bet it sucks to be you right now (ooh)""", [packId, 9, 9])



gen.InsertSong("My Number", ["Foals"], "Holy Fire", """You don't have my number
