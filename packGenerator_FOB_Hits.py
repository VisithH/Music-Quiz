...
packId = gen.CreatePack("FOB Hits", "TWitham")

gen.InsertSong("Dance Dance", ["Fall Out Boy"], "From Under the Cork Tree", """She says, she's no good with words but I'm worse
...
Dance, dance
Dance, dance
Dance, dance""", [packId, 1, 7])



gen.InsertSong("I Don't Care", ["Fall Out Boy"], "Folie à Deux", """Ohh
Ohhh
...
I said I don't care what you think
As long as it's about me
The best of us can find happiness in misery""", [packId, 12, 6])



gen.InsertSong("Grand Theft Autumn/Where Is Your Boy", ["Fall Out Boy"], "Take This to Your Grave", """Where is your boy tonight?
...
I hope he is a gentleman
Maybe he won't find out what I know
You were the last good thing about this part of town""", [packId, 17, 8])

gen.InsertSong("This Ain't a Scene, It's an Arms Race", ["Fall Out Boy"], "Infinity on High", """I am an arms dealer fitting you with
...
Fast enough
Sing 'til your lungs give out
'Cause this ain't a scene, it's a goddamn arms race
This ain't a scene, it's a goddamn arms race
(Now you)
This ain't a scene, it's a goddamn arms race
This ain't a scene, it's a goddamn arms race
...
I'm a leading man
And the lies I weave are oh so intricate
So intricate""", [packId, 14, 4])

gen.InsertSong("Just One Yesterday", ["Fall Out Boy", "Foxes"], "Save Rock and Roll", """I thought of angels choking on their halos
...
I don't have the right name o-o-or the right looks
...
If heaven's grief brings hell's rain (yeah)
Then I'd trade all my tomorrows for just one yesterday
(I know I'm bad news) yeah
For just one yesterday
(I saved it all for you)
I want to teach you a lesson in the worst kind of way
Still, I'd trade all my tomorrows for just one yesterday
...
For just one yesterday
(I saved it all for you)
For just one yesterday""", [packId, 1, 2])

gen.InsertSong("The Last Of The Real Ones", ["Fall Out Boy"], "MANIA", """I was just an only child of the universe
...
You're just the last of the real ones
(You're just the last of the real ones)
You're just the last of the real ones""", [packId, 16, 6])